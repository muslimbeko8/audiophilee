      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-5 gap-8">
        <div>
          ...
          <div className="flex items-center rounded border-[1.5px] border-[#FAFAFA] overflow-hidden">
            ...
            />
            <button>
              <ArrowRightTwoToneIcon width={24} height={24} />
            </button>
          </div>
        </div>
        ...
        <div>
          ...
          <p className="mb-4 text-xs font-medium opacity-70">
            Save $3 with App New User Only
          </p>
          <div className="flex gap-3 text-center">
            <img src={qrcode.src} alt="QR Code" className="mb-4 w-24 h-24" />
            <div className="flex gap-2 flex-col">
              <img
                ...
                className="w-32 h-10"
              />
              <img src={appStore.src} alt="App Store" className="w-32 h-10" />
            </div>
          </div>
          <div className="flex space-x-4 mt-6">
            <a href="https://facebook.com">
              <FacebookTwoToneIcon sx={{ width: 30, height: 30 }} />
            </a>

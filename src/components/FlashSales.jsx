  ...
  return (
    <div className="container mx-auto mt-36">
      ...
      <div className="flex justify-center my-16">
        <Link
          href={"/products"}
          className="bg-[#DB4444] items-center flex justify-center rounded-[4px] w-[234px] h-[56px] capitalize text-[#FAFAFA] font-medium text-base"
        >
          View all products
        </Link>
      </div>
